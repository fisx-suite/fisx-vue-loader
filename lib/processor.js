...
function processVuePart(part, filePath, opts, needSourceMap) {
    ...
    var compile = compiler.find(part.lang || opts.lang);
    if (!compile) {
...
exports.processTemplate = function (part, filePath, opts, needSourceMap) {
    ...
    var compileResult = compileTemplate(filePath, output, opts.compile || {});
...
exports.processStyle = function (part, filePath, id, opts, needSourceMap) {
    ...
    var data = rewriteStyle(filePath, id, output, part.scoped, opts, output.map);
    if (data.error) {
